...
describe("Day 9 parse", () => {
  it("should parse", () => {
    const result = day9.parse(sampleInput);
...
describe("Day 9 part1", () => {
  it("should work", () => {
    const data = day9.parse(sampleInput);
    expect(day9.part1(data, 5)).toEqual(127);
  });
  it("should solve", () => {
    const data = day9.parse(puzzleInput[0]);
    expect(day9.part1(data, 25)).toEqual(1038347917);
  });
});
...
describe("Day 9 part2", () => {
  it("should work", () => {
    const data = day9.parse(sampleInput);
    expect(day9.part2(data, 5)).toEqual(62);
  });
  it("should solve", () => {
    const data = day9.parse(puzzleInput[0]);
