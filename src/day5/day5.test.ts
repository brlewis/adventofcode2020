...
const sampleInput = ["BFFFBBFRRR", "FFFBBBFRRR", "BBFFBBFRLL"];
...
describe("Day 5 parse", () => {
  it("should parse", () => {
    const result = day5.parse(sampleInput);
    expect(result).toEqual([567, 119, 820]);
  });
});

describe("Day 5 part1", () => {
  it("should work", () => {
    const data = day5.parse(sampleInput);
    expect(day5.part1(data)).toEqual(820);
  });
  it("should solve", () => {
    const data = day5.parse(puzzleInput);
    expect(day5.part1(data)).toEqual(828);
  });
});
...
describe("Day 5 part2", () => {
  it("should solve", () => {
    const data = day5.parse(puzzleInput);
    expect(day5.part2(data)).toEqual(565);
  });
});
