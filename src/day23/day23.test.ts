...
/**
 * --- Day 23: Crab Cups ---The small crab challenges you to a game! The crab is going to mix up some cups, and you have to predict where they'll end up.
...
describe("Day 23 parse", () => {
  it("should parse", () => {
    const result = day23.parse(sampleInput[0]);
    expect(result).toEqual([[3, 8, 9, 1, 2, 5, 4, 6, 7]]);
  });
});

describe("Day 23 part1", () => {
  it("should work", () => {
    const data = day23.parse(sampleInput[0])[0];
    expect(day23.part1(data, 10)).toEqual("92658374");
    expect(day23.part1(data, 100)).toEqual("67384529");
  });
  it("should solve", () => {
    const data = day23.parse(puzzleInput[0])[0];
    expect(day23.part1(data, 100)).toEqual("28946753");
  });
});
