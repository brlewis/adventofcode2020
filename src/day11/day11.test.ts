...
describe("Day 11 parse", () => {
  it("should parse", () => {
    const result = day11.parse(sampleInput);
    expect(result[1].join("")).toEqual(".L.LL.LL.LL.");
  });
});

describe("Day 11 part1", () => {
  it("should work", () => {
    const data = day11.parse(sampleInput);
    expect(day11.part1(data)).toEqual(37);
  });
  it("should solve", () => {
    const data = day11.parse(puzzleInput[0]);
    expect(day11.part1(data)).toEqual(2354);
  });
});

describe("Day 11 part2", () => {
  it("should work", () => {
    const data = day11.parse(sampleInput);
    expect(day11.part2(data)).toEqual(26);
  });
  it("should solve", () => {
    const data = day11.parse(puzzleInput[0]);
    expect(day11.part2(data)).toEqual(2072);
  });
});
