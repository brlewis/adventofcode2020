...
describe("Day 8 parse", () => {
  it("should parse", () => {
    const result = day8.parse(sampleInput);
    expect(result[0].op).toEqual("nop");
  });
});

describe("Day 8 part1", () => {
  it("should work", () => {
    const data = day8.parse(sampleInput);
    expect(day8.part1(data)).toEqual(5);
  });
  it("should solve", () => {
    const data = day8.parse(puzzleInput[0]);
    expect(day8.part1(data)).toEqual(1801);
  });
});

describe("Day 8 part2", () => {
  it("should work", () => {
    const data = day8.parse(sampleInput);
    expect(day8.part2(data)).toEqual(8);
  });
  it("should solve", () => {
    const data = day8.parse(puzzleInput[0]);
    expect(day8.part2(data)).toEqual(2060);
  });
});
